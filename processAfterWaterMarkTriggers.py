...
tumblingWindow = (
    ...
    | "Create window" >> beam.WindowInto(window.FixedWindows(20),trigger=AfterWatermark(early=AfterProcessingTime(10),late=AfterCount(2)),accumulation_mode=AccumulationMode.DISCARDING)
